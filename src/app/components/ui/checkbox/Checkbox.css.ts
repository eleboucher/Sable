...
export const CheckboxCheckIcon = recipe({
  base: [DefaultReset, { flexShrink: '0', color: 'currentColor' }],
  variants: { size: CrossSizeVariant },
  defaultVariants: { size: '400' },
});

export type CheckboxCheckIconVariants = RecipeVariants<typeof CheckboxCheckIcon>;
